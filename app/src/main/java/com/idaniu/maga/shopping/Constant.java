...
//    public static final String HOME_URL = "http://112.124.22.238:8081/course_api/campaign/recommend";   //初始
    ...
    //热卖页瀑布流的网络资源地址
//    public static final String HOT_URL = HOST + "/course_api/wares/hot";                  //这是之前的，现在这个服务业面关闭了
    public static final String HOT_URL = "http://www.yuanbao15.club/ybfile/hot.json";       //yb自己的
